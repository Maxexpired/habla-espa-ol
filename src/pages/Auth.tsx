...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-serene-accent to-serene-primary p-4 relative overflow-hidden">
